...
def seed(apps, schema_editor):
    ...
    random_user1, _ = siteuser_model.objects.get_or_create(username='Joe B.', password=''.join(secrets.choice(alphabet) for _ in range(20)), role='customer')
    random_user2, _ = siteuser_model.objects.get_or_create(username='Sebastian S.', password=''.join(secrets.choice(alphabet) for _ in range(20)), role='customer')
