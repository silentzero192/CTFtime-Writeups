...
def seed(apps, schema_editor):
    ...
    admin_user, _ = siteuser_model.objects.get_or_create(username=''.join(secrets.choice(alphabet) for _ in range(20)), password=''.join(secrets.choice(alphabet) for _ in range(32)), role='admin')
